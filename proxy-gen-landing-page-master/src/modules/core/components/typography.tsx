...
const typographyVariants = cva<TypographyVariants>("font-medium", {
  variants: {
    variant: {
      ...
      title:
        "text-white font-bold text-xxl md:text-2xl lg:text-3xxl leading-tight capitalize",
      sectitle:
        "text-xxl md:text-2xl lg:text-3xxl font-black leading-sm capitalize",
      sectitleWhite:
        "text-white text-xxl md:text-2xl lg:text-3xxl font-black leading-sm",
